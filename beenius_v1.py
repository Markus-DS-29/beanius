...
if st.session_state.set_language == 'de':
    greeting = "Willkommen bei Beenius, deinem Honig-Experten."
    first_question = "Was für einen Honig suchst du?"
    start_recording = "Aufnahme starten"
    stop_recording = "Aufnahme beenden"
    grinding = "Sammle die Antwort..."
else: 
    greeting = "Welcome to Beenius, your Honey expert."
    first_question = "What kind of honey are you looking for?" 
    start_recording = "Start recording"
    stop_recording = "Stop recording"
    grinding = "Collecting an answer..."
...
if st.session_state.set_language == "de":
    ...
    Most Important: Always add the 1 according url to your answer, if it comes from https://www.heimathonig.de/ ! 
